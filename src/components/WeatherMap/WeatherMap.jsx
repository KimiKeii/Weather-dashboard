...
export default function WeatherMap({ location }) {
  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden rounded-[32px] bg-[#48b5c9] p-5 shadow-sm">
      ...
      <div className="mt-14 flex-1 overflow-hidden rounded-[28px] border border-white/20 bg-slate-900 shadow-inner">
        <div className="relative h-full w-full overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.24),transparent_40%)]" />
